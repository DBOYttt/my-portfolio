...
export const AdminDashboard: React.FC = () => {
  ...
  const tx = interpolate(frame, [0, DURATION], [0, -10], { extrapolateRight: "clamp" });
  ...
  return (
    <AbsoluteFill style={{ background: "#000" }}>
      ...
      <Callout frame={frame} from={20} to={88} x={10} y={90} label="10 admin sections" />
      <Callout frame={frame} from={35} to={120} x={285} y={165} label="Live stats — Posts · Projects · Skills" />
      <Callout frame={frame} from={65} to={145} x={285} y={305} label="AI agent insights — 5 unread reports" />
    </AbsoluteFill>
  );
};
