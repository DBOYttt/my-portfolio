...
export const PublicAbout: React.FC = () => {
  ...
  const ty = interpolate(frame, [0, DURATION], [0, -6], { extrapolateRight: "clamp" });
  ...
  return (
    <AbsoluteFill style={{ background: "#000" }}>
      <div style={{
        ...
        <Img
          src={staticFile("screenshots/public-about.png")}
      ...
      <Callout frame={frame} from={25} to={110} x={68} y={85} label="§01 About" />
      <Callout frame={frame} from={50} to={128} x={300} y={85} label="Bio — software + robotics background" />
      <Callout frame={frame} from={70} to={138} x={68} y={200} label="2-column logbook layout" />
    </AbsoluteFill>
  );
};
