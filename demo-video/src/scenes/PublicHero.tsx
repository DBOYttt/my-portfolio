...
export const PublicHero: React.FC = () => {
  ...
  const tx = interpolate(frame, [0, DURATION], [0, 8], { extrapolateRight: "clamp" });
  ...
  return (
    <AbsoluteFill style={{ background: "#000" }}>
      <div style={{
        ...
        <Img
          src={staticFile("screenshots/public-hero.png")}
      ...
      <Callout frame={frame} from={30} to={120} x={300} y={140} label="OPEN TO OPPORTUNITIES — SPRING 2026" />
      <Callout frame={frame} from={55} to={130} x={300} y={480} label="Software engineer, robotics builder, perpetual tinkerer" />
      <Callout frame={frame} from={80} to={148} x={68} y={125} label="Kraków, Poland" />
    </AbsoluteFill>
  );
};
