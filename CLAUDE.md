...
**Next milestones:**
- **M7.5 — Career-Ops Integration** — Replace `cv-generator` and `opportunity-watcher` agents with [career-ops](https://github.com/santifer/career-ops), a standalone AI job-search pipeline. Portfolio retains a single public `/cv.pdf`; all job hunting moves outside this repo.
