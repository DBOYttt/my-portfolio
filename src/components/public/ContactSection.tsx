    ...
    <label style={{ display: "block" }}>
      ...
      >
        ...
        {error ? (
          <span
            className="mono"
            style={{ fontSize: 11, color: "var(--accent)", fontStyle: "italic" }}
          >
            !! {error}
          </span>
        ) : null}
      </div>
      {/* Apply logbook input styles via cloneElement */}
      {React.cloneElement(children, { style: { ...fieldInputStyle, ...children.props.style } })}
    </label>
  );
}
          ...
          {sent ? (
            ...
            >
              ...
              >
                ...
                <h3 className="serif" style={{ fontSize: 28, fontWeight: 500 }}>
                  Logged.
                </h3>
              </div>
            ...
            <form
              ...
              className="stack"
              style={{ ["--gap" as string]: "20px", maxWidth: 620 }}
            >
              <Field2
                label="Name"
                k="01"
                error={touched.name && !form.name.trim() ? "required" : null}
              >
                <input
                  name="name"
                  value={form.name}
              ...
              <Field2
                label="Email"
                k="02"
                error={touched.email && !emailValid ? "expected an email" : null}
              >
                <input
                  name="email"
                  type="email"
              ...
              <Field2
                label="Message"
                k="03"
                error={touched.message && form.message.trim().length <= 8 ? "too short" : null}
              >
                <textarea
                  name="message"
                  rows={5}
              ...
              {sendError && (
                <p
                  className="mono"
                  style={{ fontSize: 12, color: "var(--accent)", letterSpacing: "0.04em" }}
                >
